/* This file contains the logic to recover a user password*/
const { SearchUser } = require('./../../models/users')
const { CreateToken } = require('./../../models/recover_tokens')
...
const PasswordRecover = (email) => {
    return new Promise(async(resolve,reject) => {
        try {
            ...
            const { tokenHash } = await createToken(userId)
            await linkSender(tokenHash,email)
            resolve()
        } catch (error) {
            reject(error)
        }
...
const linkSender = (tokenHash,userEmail) => {
    return new Promise(async(resolve,reject) => {
        try {
            ...
            const url = `http://localhost:8080/password-forget/${tokenHash}`
            ...
            * {
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                  ...
                  <img align="center" border="0" src="https://i.imgur.com/CSeZ9yK.png" alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 30%;max-width: 180px;" width="180" class="v-src-width v-src-max-width"/>
            ...
            <table id="u_content_heading_3" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 22px; font-weight: 400;"><strong>Enlace para cambiar tu contraseña</strong></h1>
            ...
            <table id="u_content_heading_2" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <h1 class="v-text-align v-font-size" style="margin: 0px; color: #5c5c5c; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 14px; font-weight: 400;">Has olvidado tu contraseña ? Mediante este enlace podrás reestablecerla<br /><strong>Enlace valido por 10 minutos</strong></h1>
            ...
            <div class="v-text-align" align="center">
              <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:37px; v-text-anchor:middle; width:186px;" arcsize="11%"  stroke="f" fillcolor="#4180e2"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Raleway',sans-serif;"><![endif]-->  
                <a href="${url}" target="_blank" class="v-button v-font-size" style="box-sizing: border-box;display: inline-block;font-family:'Raleway',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #4180e2; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
                  <span style="display:block;padding:10px 20px;line-height:120%;"><span style="line-height: 16.8px;">Cambiar tu contraseña</span></span>
                </a>
            ...
            <table id="u_content_heading_4" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 20px; font-weight: 400;"><strong>Confirmacion de cambio de contraseña</strong></h1>
            ...
            <table id="u_content_text_2" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
              ...
              <div class="v-text-align v-font-size" style="font-size: 14px; line-height: 140%; text-align: justify; word-wrap: break-word;">
                <p style="line-height: 140%;">Este correo ha sido solicitado mediante la funcionalidad de "Olvide mi contraseña". En caso de que no hayas solicitado este correo, <strong>notifícalo inmediatamente a el administrador y elimina el correo.</strong></p>
              </div>
            ...
            const mailStructure = {
                ...
                to:userEmail,
                subject: 'Link para cambio de contraseña CBS',
                html,
            }
            const emailInfo = await transporter.sendMail(mailStructure)
            resolve(emailInfo)
        } catch (error) {
            reject(error)
        }
...
const checkEmail = (emailToCheck) => {
    return new Promise(async(resolve,reject) => {
        try {
            const foundUser = await SearchUser({email:emailToCheck})
            if(!foundUser){
                reject(new Error('Email doesnt exists',{cause:'UserInput'}))
                return
            }
